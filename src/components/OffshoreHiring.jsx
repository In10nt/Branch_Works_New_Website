  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      ...
      try {
        ...
        // Filter only Offshore Hiring category blogs
        const offshoreBlogs = data.filter(blog => blog.category === 'Offshore Hiring');
        setCustomerStoryBlogs([staticBlog, ...offshoreBlogs]);
      } catch (error) {
