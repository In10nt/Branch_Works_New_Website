  ...
  useEffect(() => {
    const fetchBlogs = async () => {
      ...
      try {
        ...
        // Filter only Technology Support category blogs
        const techBlogs = data.filter(blog => blog.category === 'Technology Support');
        setCustomerStoryBlogs([staticBlog, ...techBlogs]);
      } catch (error) {
